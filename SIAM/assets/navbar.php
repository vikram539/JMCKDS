    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-6 col-xl-6">
                <div class="navLeft">
                    <div class="logo">
                        <a href="<?=$root ?>"><img src="<?=$images ?>logo.png" alt="Logo" class="img-fluid" />
                            <span>Swiss International Asset Management</span>
                        </a>
                    </div>
                </div>
            </div>
            <div class="col-xs-4 col-sm-4 col-md-4 col-lg-6 col-xl-6 d-flex align-items-center justify-content-end" id='navHover'>
                <div class="navRight">
