<section class="thumb-action container-fluid mt-4 mb-4 pt-4 pb-4">
	<div class="row">
		<?php
			...
			$aprt_thumb_sel=$fun_obj->commonSelect_table("cms_pages","page_ID^page_name^filename","WHERE sub_menu_active='y' AND flag='$room_id' ORDER BY page_order ASC limit 4");
			while($aprt_thumb_run=mysqli_fetch_array($aprt_thumb_sel)){
				...
				echo"<div class='col-xs-12 col-sm-12 col-md-6 col-lg-3 col-xl-3"?> <?php if($page_ID==$roomID) echo 'd-none' ?><?php echo"'>
		...
		<div class='col-xs-12 col-sm-12 col-md-6 col-lg-3 col-xl-3'>
			<div class='thumb-action-img more-acc'>
				<img src='<?=$website_images?>read-more.jpg' alt='Read More' title='Read More' class='img-fluid' />
					<a href='<?=$website_domain?>accommodation.php'>view more</a>
			</div>
		</div> */?>
	</div>
</section>